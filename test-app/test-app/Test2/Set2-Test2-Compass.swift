...
// MARK: - View model
/*
final class Set2CompassTaskViewModel: ObservableObject {
...
private extension Set2Test2View {
    ...
    func proceedToNextTest() {
        recordResultIfNeeded()
        router.go(to: .set2Test3)
    }
}
/*
struct Set2CompassGraphic: View {
