...
struct Set2Test5View: View {
    @Environment(\.dismiss) private var dismiss
    @EnvironmentObject private var router: NavigationRouter
    @EnvironmentObject private var resultsStore: ResultsStore
    @Environment(\.modelContext) private var modelContext
    @StateObject private var viewModel = Set2MemoryTaskViewModel()
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                ...
                                .frame(width: geometry.size.width * CGFloat(viewModel.timeRemaining / Set2MemoryTaskViewModel.totalDuration))
...
final class Set2MemoryTaskViewModel: ObservableObject {
...
private extension Set2Test5View {
