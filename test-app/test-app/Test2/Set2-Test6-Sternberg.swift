...
struct Set2Test6View: View {
    @Environment(\.dismiss) private var dismiss
    @EnvironmentObject private var router: NavigationRouter
    @EnvironmentObject private var resultsStore: ResultsStore
    @Environment(\.modelContext) private var modelContext
    @StateObject private var viewModel = Set2MemoryPositionTaskViewModel()
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                ...
                                .frame(width: geometry.size.width * CGFloat(viewModel.timeRemaining / Set2MemoryPositionTaskViewModel.totalDuration))
    ...
    private var resultsOverlay: some View {
        VStack(spacing: 8) {
            ...
            Button(action: goToNextTest) {
                Text("Continue to Stroop Test I")
                    .font(.title)
                    .padding(.vertical, 6)
                    .frame(maxWidth: .infinity)
            }
...
final class Set2MemoryPositionTaskViewModel: ObservableObject {
...
private extension Set2Test6View {
