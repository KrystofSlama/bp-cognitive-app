...
struct DemoTest5View: View {
    @Environment(\.dismiss) private var dismiss
    @EnvironmentObject private var router: NavigationRouter
    @EnvironmentObject private var resultsStore: ResultsStore
    @Environment(\.modelContext) private var modelContext
    @StateObject private var viewModel = DemoMemoryTaskViewModel()
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                ...
                                .frame(width: geometry.size.width * CGFloat(viewModel.timeRemaining / DemoMemoryTaskViewModel.totalDuration))
...
final class DemoMemoryTaskViewModel: ObservableObject {
...
private extension DemoTest5View {
