...
struct DemoTest3View: View {
    @Environment(\.dismiss) private var dismiss
    @EnvironmentObject private var router: NavigationRouter
    @EnvironmentObject private var resultsStore: ResultsStore
    @Environment(\.modelContext) private var modelContext
    @StateObject private var viewModel = DemoCompassLetterTaskViewModel()
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                ...
                                .frame(width: geometry.size.width * CGFloat(viewModel.timeRemaining / DemoCompassLetterTaskViewModel.totalDuration))
    ...
    private func compassColumn(title: String, pointer: CompassDirectionDemo?, isReference: Bool, isNavod: Bool, displayedLetter: String?) -> some View {
        VStack(spacing: 12) {
            Text(title)
                .font(.headline)
            if isReference {
                DemoCompassGraphic(centerLabel: nil, isReference: isReference, isNavod: isNavod, pointerDir: pointer, displayedLetter: displayedLetter)
...
final class DemoCompassLetterTaskViewModel: ObservableObject {
...
private extension DemoTest3View {
