...
struct DemoTest4View: View {
    @Environment(\.dismiss) private var dismiss
    @EnvironmentObject private var router: NavigationRouter
    @EnvironmentObject private var resultsStore: ResultsStore
    @Environment(\.modelContext) private var modelContext
    @StateObject private var viewModel = DemoRunwayTaskViewModel()
    ...
    private var mainContent: some View {
        VStack(alignment: .center) {
            ...
            if testStarted {
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                ...
                                .frame(width: geometry.size.width * CGFloat(viewModel.timeRemaining / DemoRunwayTaskViewModel.totalDuration))
                ...
                if let preview = DemoRunwayTaskViewModel.stimuli.first {
    ...
    private func runwayCard(for stimulus: DemoRunwayStimulus) -> some View {
        VStack(spacing: 12) {
    ...
    private func directionButton(direction: CompassDirectionDemo, systemName: String) -> some View {
        Button {
            viewModel.handleSelection(direction)
        } label: {
    ...
    private var resultsOverlay: some View {
        VStack(spacing: 8) {
            ...
            Button(action: proceedToNextTest) {
                Text("Continue to Sternberg Test")
                    .font(.title)
                    .padding(.vertical, 6)
...
final class DemoRunwayTaskViewModel: ObservableObject {
    @Published var currentStimulus: DemoRunwayStimulus? = nil
    ...
    static let stimuli: [DemoRunwayStimulus] = [
        DemoRunwayStimulus(imageName: "RWY_00", headingNumber: 0),
        DemoRunwayStimulus(imageName: "RWY_09", headingNumber: 9),
        DemoRunwayStimulus(imageName: "RWY_18", headingNumber: 18),
        DemoRunwayStimulus(imageName: "RWY_27", headingNumber: 27),
        DemoRunwayStimulus(imageName: "RWY_00_2", headingNumber: 0),
        DemoRunwayStimulus(imageName: "RWY_09_2", headingNumber: 9),
        DemoRunwayStimulus(imageName: "RWY_18_2", headingNumber: 18),
        DemoRunwayStimulus(imageName: "RWY_27_2", headingNumber: 27),
        DemoRunwayStimulus(imageName: "RWY_00_3", headingNumber: 0),
        DemoRunwayStimulus(imageName: "RWY_09_3", headingNumber: 9),
        DemoRunwayStimulus(imageName: "RWY_18_3", headingNumber: 18),
        DemoRunwayStimulus(imageName: "RWY_27_3", headingNumber: 27),
    ]
    ...
    func handleSelection(_ direction: CompassDirectionDemo) {
...
struct DemoRunwayStimulus: Identifiable {
    let id = UUID()
    ...
    var expectedDirection: CompassDirectionDemo? {
        CompassDirectionDemo(headingDegrees: headingDegrees)
    }
}

// MARK: - Completion handling

private extension DemoTest4View {
...
private struct ArrowKeyHandlingView: View {
    var onArrowPress: (CompassDirectionDemo) -> Void
...
extension CompassDirectionDemo {
