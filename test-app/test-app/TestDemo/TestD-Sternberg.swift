...
struct DemoTest6View: View {
    @Environment(\.dismiss) private var dismiss
    @EnvironmentObject private var router: NavigationRouter
    @EnvironmentObject private var resultsStore: ResultsStore
    @Environment(\.modelContext) private var modelContext
    @StateObject private var viewModel = DemoMemoryPositionTaskViewModel()
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                ...
                                .frame(width: geometry.size.width * CGFloat(viewModel.timeRemaining / DemoMemoryPositionTaskViewModel.totalDuration))
...
final class DemoMemoryPositionTaskViewModel: ObservableObject {
...
private extension DemoTest6View {
