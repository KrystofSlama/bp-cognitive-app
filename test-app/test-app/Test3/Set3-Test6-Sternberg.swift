...
struct Set3Test6View: View {
    @Environment(\.dismiss) private var dismiss
    @EnvironmentObject private var router: NavigationRouter
    @EnvironmentObject private var resultsStore: ResultsStore
    @Environment(\.modelContext) private var modelContext
    @StateObject private var viewModel = Set3MemoryPositionTaskViewModel()
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                ...
                                .frame(width: geometry.size.width * CGFloat(viewModel.timeRemaining / Set3MemoryPositionTaskViewModel.totalDuration))
...
final class Set3MemoryPositionTaskViewModel: ObservableObject {
...
private extension Set3Test6View {
