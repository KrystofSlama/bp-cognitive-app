...
// MARK: - View model
/*
final class Set3CompassTaskViewModel: ObservableObject {
...
/*
enum CompassDirection2: String, CaseIterable, Equatable {
    case s = "S" // sever
    case z = "Z" // západ
    case j = "J" // jih
    case v = "V" // východ
...
private extension Set3Test2View {
    ...
    func proceedToNextTest() {
        recordResultIfNeeded()
        router.go(to: .set3Test3)
    }
}
/*
struct Set3CompassGraphic: View {
