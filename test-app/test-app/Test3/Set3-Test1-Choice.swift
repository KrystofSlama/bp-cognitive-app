...
struct Set3Test1View: View {
            ...
            if testStarted {
                ...
                VStack(spacing: 8) {
                    ...
                    labeledRow(title: "Press Key", content: {
                        boxesRow(labels: ChoiceTaskViewModel.keyOrder)
                    })
                }
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                ...
                                .frame(width: geometry.size.width * CGFloat(viewModel.timeRemaining / ChoiceTaskViewModel.totalDuration))
    ...
    private func proceedToNextTest() {
        recordResultIfNeeded()
        router.go(to: .set3Test2)
    }
}

// MARK: - View model
/*
final class Set3ChoiceTaskViewModel: ObservableObject {
    ...
    static let totalDuration: TimeInterval = 10 //60 //90   // Cas testu
