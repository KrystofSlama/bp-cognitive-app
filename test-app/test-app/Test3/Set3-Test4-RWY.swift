...
struct Set3Test4View: View {
    @Environment(\.dismiss) private var dismiss
    @EnvironmentObject private var router: NavigationRouter
    @EnvironmentObject private var resultsStore: ResultsStore
    @Environment(\.modelContext) private var modelContext
    @StateObject private var viewModel = Set3RunwayTaskViewModel()
    ...
    private var mainContent: some View {
        VStack(alignment: .center) {
            ...
            if testStarted {
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Capsule()
                                ...
                                .frame(width: geometry.size.width * CGFloat(viewModel.timeRemaining / Set3RunwayTaskViewModel.totalDuration))
                ...
                if let preview = Set3RunwayTaskViewModel.stimuli.first {
...
final class Set3RunwayTaskViewModel: ObservableObject {
...
private extension Set3Test4View {
